...
if (window.location.href == server_name + "/posts/add")
{
    ...
    document.getElementById('take').addEventListener("click", function(){
        if (mask.checked || star.checked || care.checked || perfect.checked)
        {
            context.clearRect(0, 0, canvas.width, canvas.height);
            context.drawImage(video, 0, 0, canvas.width, canvas.height);
            if (mask.checked == true)
                context.drawImage(elem, 10, 10, 70, 70);
            if (star.checked == true)
                context.drawImage(elem1, 570, 10, 70, 70);
            if (care.checked == true)
                context.drawImage(elem2, 10, 340, 70, 70);
            if (perfect.checked == true)
                context.drawImage(elem3, 550, 350, 70, 70);
    ...
    function choose_filter()
    {
        ...
        if (perfect.checked == true)
        {
            elem3.src = "../public/img/perfect.png";
...
function params(event)
{
    ...
    var comment_id = document.getElementById("params_"+postid);
